...
namespace RatingBooks.Persistance.Mapping.Migrations;
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UrlImagemCapaDoLivro = table.Column<string>(type: "nvarchar(max)", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_AgendamentoLivroId_PK_IdDeLivro",
                    column: x => x.LivroId,
